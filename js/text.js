...
about = [
  ...
  "Hello there !",
  "<br>",
  'My Name is </span><span class="highlight">Gurbaj Singh</span>. I am a Software Engineer with experience of',
  "working in various product based startups of about " + workingExperienceStr,
  'specialized in <span class="highlight">Backend</span> and <span class="highlight">Devops</span> with intermediate level of frontend.',
  "<br>",
